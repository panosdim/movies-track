"""Recommendation model building and training utilities."""
...
from app.routers.tmdb import fetch_movie_details
...
def train_model(model, movie_ids, ratings, genre_list, actor_list, director_list):
    ...
    for movie_id in movie_ids:
        ...
        if movie_data:
            preprocessed_data = preprocess_movie_data(
                movie_data, genre_list, actor_list, director_list
            )
            preprocessed_movies.append(preprocessed_data)
